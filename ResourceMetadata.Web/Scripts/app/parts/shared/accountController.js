(function (global) {
    ...
    app.controller('AccountCtrl', ['$scope', '$location', '$http', '$rootScope', '$modal', '$routeParams', 'accountService', 'userProfileSvc',
        function ($scope, $location, $http, $rootScope, $modal, $routeParams, accountService, userProfileSvc) {
