...
(function (global) {
    ...
    utilities.directive('sparePartAdvertsFilterOptions', ['entityService', 'manufactureService', '$route', function (entityService, manufactureService, $routeParams) {
        return {
            restrict: 'E',
            templateUrl: "/Scripts/app/parts/sparePartAdverts/sparePartAdvertsFilterOptionsDirective.html",
            scope: {
                getFilterOptions: "=",
                shouldBeFiltered: "="
            },
