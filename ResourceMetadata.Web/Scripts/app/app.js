...
app.config(['$routeProvider', '$locationProvider', '$httpProvider', '$provide', function ($routeProvider, $locationProvider, $httpProvider, $provide) {
    ...
    $routeProvider
        ...
        .when('/Manufactures', { templateUrl: '/Scripts/app/views/manufactures/Listing.html', controller: 'ManufacturesCtrl' })
        .when('/Manufactures/Add', { templateUrl: '/Scripts/app/views/manufactures/Add.html', controller: 'ManufactureCtrl' })
        .when('/Manufactures/Edit/:manufactureId', { templateUrl: '/Scripts/app/views/manufactures/Edit.html', controller: 'ManufactureCtrl' })
        .when('/Manufactures/:manufactureId', { templateUrl: '/Scripts/app/views/manufactures/Details.html', controller: 'ManufactureCtrl' })

        .when('/CarModels', { templateUrl: '/Scripts/app/views/carModels/Listing.html', controller: 'CarModelsCtrl' })
        .when('/CarModels/Add', { templateUrl: '/Scripts/app/views/carModels/Add.html', controller: 'CarModelCtrl' })
        .when('/CarModels/Edit/:carModelId', { templateUrl: '/Scripts/app/views/carModels/Edit.html', controller: 'CarModelCtrl' })
        .when('/CarModels/:carModelId', { templateUrl: '/Scripts/app/views/carModels/Details.html', controller: 'CarModelCtrl' })
